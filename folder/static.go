...
//*************************************
// Just changed the GetSampleData function to accept a filename string which makes it more flexible
//*************************************
...
func GetSampleData(filename string) []Folder {
    ...
    // Unmarshal the JSON data into the folders slice
    folders := []Folder{}
